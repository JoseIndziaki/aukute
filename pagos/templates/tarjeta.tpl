...
<table width=600>
	...
	<tr>
		...
		<td align=left><p>
			<select name=expDateMonth id="mes">
			...
			<select name=expDateYear id="anio">
	...
	<tr>
		<td align=right><br>
		Total:</td>
		<td align=left><br><input name="amount" value="{$total}" type="text" size="7" maxlength="7" readonly>MXN</td>
	</tr>
	<tr>
		<td/>
		<td align=left>&nbsp;</td>
	...
	<tr>
		<td/>
            ...
            <input type="hidden" name="precio" id="precio" value="{$total}" />
