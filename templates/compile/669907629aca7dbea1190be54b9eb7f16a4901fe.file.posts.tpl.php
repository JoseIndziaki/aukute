<?php /* Smarty version Smarty-3.1.14, created on 2013-10-06 01:23:58
         compiled from "templates\posts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:761452479a17c3c957-21581456%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '669907629aca7dbea1190be54b9eb7f16a4901fe' => 
    array (
      0 => 'templates\\posts.tpl',
      1 => 1381019066,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '761452479a17c3c957-21581456',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52479a17eeca56_82602217',
  'variables' => 
  array (
    'post' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_52479a17eeca56_82602217')) {function content_52479a17eeca56_82602217($_smarty_tpl) {?><?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['mysec'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['mysec']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['mysec']['name'] = 'mysec';
$_smarty_tpl->tpl_vars['smarty']->value['section']['mysec']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['post']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
<div>
    <hr />
	<div><a href="news.php?id=<?php echo $_smarty_tpl->tpl_vars['post']->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['id'];?>
"><h3><?php echo $_smarty_tpl->tpl_vars['post']->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['titulo'];?>
</h3></a></div>
	<div id="contenido"><?php echo $_smarty_tpl->tpl_vars['post']->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['noticia'];?>
</div>
</div>
